    ...
    class AnalysisObject {
        ...
        watchChanges() { //meant as a router that chooses what charts to produce depending on the inputs
            ...
            if (this.usingThese.length > 0 && this.type === 'compare' && this.groupedBy != "") {
                //create the data and code needed to generate a clustered bar chart (maybe even for stacked chart or matrix)
                // render clustered once the code and data is ready
            }
        }
